...
<body>
    ...
    <!-- main part -->
    <div class=" container col-md-5 col-sm-5 col-lg-5" id="status">
        <form action="stconnection.php" mathod="POST">
            <h3><b>Check Complain</b></h3>
            <div class="">
                complaint ID
                <input type="number" class="form-control" name="id" placeholder="complain id" aria-label="comp ID" id="id">
            </div><br>

            <div class="">
                Complain type
                <input type="text" class="form-control" name="comp" placeholder="complaint" aria-label="complaint" id="comp">
            </div><br>
            <div class="col-md-8">
